%EVERY VARIABLE HAS IT'S OWN PAGE
  ...
  % '#' has to be escaped
	...
	<#if sameVariablesInPanel[panelIdentifier]?has_content>
	  Panel variables: & <#list sameVariablesInPanel[panelIdentifier] as sameVariableInPanel>${sameVariableInPanel.name}<#sep>, </#sep></#list>
    </#if>
    \end{tabularx}
