%EVERY VARIABLE HAS IT'S OWN PAGE
  ...
  % '#' has to be escaped
	...
	<#if sameVariablesInPanel[variable.id]?has_content>
	  Panel Variables: & <#list sameVariablesInPanel[variable.id] as sameVariableInPanel>${sameVariableInPanel.name}<#sep>, </#sep></#list>
    </#if>
    \end{tabularx}
